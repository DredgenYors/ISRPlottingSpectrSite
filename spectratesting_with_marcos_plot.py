...
if __name__ == "__main__":
    ...
    nu_e = 3.32424637026162  # Electron collision frequency in Hz
    ni =  2e11  # Ion and electron densities in m^-3
    ne_ = 2e11
    mi = 2.65686e-26  # Ion mass (atomic oxygen) in kga
    m_e = 9.11e-31  # Electron mass [kg]
    B = 3.60e-2  # Magnetic field strength in Tesla
    theta = 0  # Scattering angle in degrees
    ...
    nu_e_marco = plasma_tmp.collision_frequency(0, 2, kB=k_total, aspdeg=90)[0]
    nu_i_marco = plasma_tmp.collision_frequency([1], 2, kB=k_total, aspdeg=90)[0]
